...
/** @constructor */
function $c_Lpong_Action() {
  $c_O.call(this)
}
$c_Lpong_Action.prototype = new $h_O();
$c_Lpong_Action.prototype.constructor = $c_Lpong_Action;
/** @constructor */
function $h_Lpong_Action() {
  /*<skip>*/
}
$h_Lpong_Action.prototype = $c_Lpong_Action.prototype;
$c_Lpong_Action.prototype.init___ = (function() {
  return this
});
$c_Lpong_Action.prototype.endGame__Z__V = (function(isOver) {
  if (isOver) {
    $m_Lpong_Game$().status$1 = $m_Lpong_Game$Status$().GameOver$2
  }
});
$c_Lpong_Action.prototype.load__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__V = (function(playgroundHTML, racketHTML, ballHTML, scoreHTML, startHTML, gameOverHTML) {
  var executeLoop = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, playgroundHTML$1, racketHTML$1, ballHTML$1, scoreHTML$1, gameOverHTML$1) {
    return (function() {
      $this.loop__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__V(playgroundHTML$1, racketHTML$1, ballHTML$1, scoreHTML$1, gameOverHTML$1)
    })
  })(this, playgroundHTML, racketHTML, ballHTML, scoreHTML, gameOverHTML));
  $g.setInterval((function(f) {
    return (function() {
      return f.apply__O()
    })
  })(executeLoop), 16.0);
  var markAsPressed = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2) {
    return (function(evt$2) {
      var this$1 = $m_Lpong_Game$().pressedKey$1;
      var key = $uI(evt$2.keyCode);
      this$1.put__O__O__s_Option(key, true)
    })
  })(this));
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().addEventListener("keydown", (function(f$1) {
    return (function(arg1) {
      return f$1.apply__O__O(arg1)
    })
  })(markAsPressed));
  var markAsNotPressed = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$3) {
    return (function(evt$3$2) {
      var this$4 = $m_Lpong_Game$().pressedKey$1;
      var key$1 = $uI(evt$3$2.keyCode);
      this$4.put__O__O__s_Option(key$1, false)
    })
  })(this));
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().addEventListener("keyup", (function(f$2) {
    return (function(arg1$1) {
      return f$2.apply__O__O(arg1$1)
    })
  })(markAsNotPressed));
  var startGame = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$4$1, startHTML$1) {
    return (function(x$1$2) {
      if ($m_Lpong_Game$().state$1.isStoped__Z()) {
        $m_Lpong_Game$().status$1 = $m_Lpong_Game$Status$().Running$2;
        startHTML$1.style.display = "none"
      }
    })
  })(this, startHTML));
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().addEventListener("keydown", (function(f$3) {
    return (function(arg1$2) {
      return f$3.apply__O__O(arg1$2)
    })
  })(startGame))
});
$c_Lpong_Action.prototype.loop__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__V = (function(playgroundHTML, racketHTML, ballHTML, scoreHTML, gameOverHTML) {
  if ($m_Lpong_Game$().state$1.isRunning__Z()) {
    var newDirX = $m_Lpong_Game$().model$1.moveBallDirectionX__Lorg_scalajs_dom_raw_HTMLDivElement__I(playgroundHTML);
    var newDirY = $m_Lpong_Game$().model$1.moveBallDirectionY__Lorg_scalajs_dom_raw_HTMLDivElement__I(playgroundHTML);
    var newPosX = $m_Lpong_Game$().model$1.moveBallPosition__I__I(newDirX);
    var newPosY = $m_Lpong_Game$().model$1.moveBallPosition__I__I(newDirY);
    $m_Lpong_Game$().model$1.changeBallPosition__I__I__I__I__V(newDirX, newPosX, newDirY, newPosY);
    $m_Lpong_Game$().view$1.drawBall__Lorg_scalajs_dom_raw_HTMLDivElement__V(ballHTML);
    var pixelPos = $m_Lpong_Game$().model$1.moveRacket__Lorg_scalajs_dom_raw_HTMLDivElement__I(racketHTML);
    $m_Lpong_Game$().view$1.drawRacket__Lorg_scalajs_dom_raw_HTMLDivElement__I__V(racketHTML, pixelPos);
    var hit = $m_Lpong_Game$().state$1.isRacketHit__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Z(racketHTML, ballHTML);
    var newScore = this.computeScore__Z__I__I(hit, $m_Lpong_Game$().score$1);
    $m_Lpong_Game$().model$1.changeDirectionY__Z__V(hit);
    $m_Lpong_Game$();
    $m_Lpong_Game$().score$1 = newScore;
    $m_Lpong_Game$().view$1.drawScore__Lorg_scalajs_dom_raw_HTMLDivElement__V(scoreHTML);
    var isOver = $m_Lpong_Game$().state$1.isGameOver__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Z(racketHTML, ballHTML);
    this.endGame__Z__V(isOver);
    $m_Lpong_Game$().view$1.drawEndGame__Lorg_scalajs_dom_raw_HTMLDivElement__Z__V(gameOverHTML, isOver)
  }
});
$c_Lpong_Action.prototype.computeScore__Z__I__I = (function(hit, score) {
  return (hit ? ((1 + score) | 0) : score)
});
var $d_Lpong_Action = new $TypeData().initClass({
  Lpong_Action: 0
}, false, "pong.Action", {
  Lpong_Action: 1,
  O: 1
});
$c_Lpong_Action.prototype.$classData = $d_Lpong_Action;
/** @constructor */
function $c_Lpong_Game$() {
  $c_O.call(this);
  this.model$1 = null;
  this.state$1 = null;
  this.view$1 = null;
  this.action$1 = null;
  this.pressedKey$1 = null;
  this.status$1 = null;
  this.score$1 = 0
}
$c_Lpong_Game$.prototype = new $h_O();
$c_Lpong_Game$.prototype.constructor = $c_Lpong_Game$;
/** @constructor */
function $h_Lpong_Game$() {
  /*<skip>*/
}
$h_Lpong_Game$.prototype = $c_Lpong_Game$.prototype;
$c_Lpong_Game$.prototype.init___ = (function() {
  $n_Lpong_Game$ = this;
  this.model$1 = new $c_Lpong_Model().init___();
  this.state$1 = new $c_Lpong_State().init___();
  this.view$1 = new $c_Lpong_View().init___();
  this.action$1 = new $c_Lpong_Action().init___();
  var self = $m_Lpong_Game$Key$().Left$2;
  var jsx$1 = new $c_T2().init___O__O(self, false);
  var self$1 = $m_Lpong_Game$Key$().Right$2;
  var array = [jsx$1, new $c_T2().init___O__O(self$1, false)];
  var this$8 = new $c_scm_HashMap().init___();
  var i = 0;
  var len = $uI(array.length);
  while ((i < len)) {
    var index = i;
    var arg1 = array[index];
    this$8.$$plus$eq__T2__scm_HashMap($as_T2(arg1));
    i = ((1 + i) | 0)
  };
  this.pressedKey$1 = this$8;
  this.status$1 = $m_Lpong_Game$Status$().Stopped$2;
  this.score$1 = 0;
  return this
});
$c_Lpong_Game$.prototype.$$js$exported$meth$startPong__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__O = (function(playgroundHTML, racketHTML, ballHTML, scoreHTML, startHTML, gameOverHTML) {
  this.action$1.load__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__V(playgroundHTML, racketHTML, ballHTML, scoreHTML, startHTML, gameOverHTML)
});
$c_Lpong_Game$.prototype.main__AT__V = (function(args) {
  /*<skip>*/
});
$c_Lpong_Game$.prototype.startPong = (function(arg$1, arg$2, arg$3, arg$4, arg$5, arg$6) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  var prep2 = arg$3;
  var prep3 = arg$4;
  var prep4 = arg$5;
  var prep5 = arg$6;
  return this.$$js$exported$meth$startPong__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__O(prep0, prep1, prep2, prep3, prep4, prep5)
});
var $d_Lpong_Game$ = new $TypeData().initClass({
  Lpong_Game$: 0
}, false, "pong.Game$", {
  Lpong_Game$: 1,
  O: 1
});
$c_Lpong_Game$.prototype.$classData = $d_Lpong_Game$;
var $n_Lpong_Game$ = (void 0);
function $m_Lpong_Game$() {
  if ((!$n_Lpong_Game$)) {
    $n_Lpong_Game$ = new $c_Lpong_Game$().init___()
  };
  return $n_Lpong_Game$
}
/** @constructor */
function $c_Lpong_Game$ball$() {
  $c_O.call(this);
  this.speed$1 = 0;
  this.x$1 = 0;
  this.y$1 = 0;
...
$c_Lpong_Game$ball$.prototype = new $h_O();
$c_Lpong_Game$ball$.prototype.constructor = $c_Lpong_Game$ball$;
/** @constructor */
function $h_Lpong_Game$ball$() {
  /*<skip>*/
}
$h_Lpong_Game$ball$.prototype = $c_Lpong_Game$ball$.prototype;
$c_Lpong_Game$ball$.prototype.init___ = (function() {
  this.speed$1 = 5;
  this.x$1 = 135;
  this.y$1 = 100;
  this.directionX$1 = (-1);
...
var $d_Lpong_Game$ball$ = new $TypeData().initClass({
  Lpong_Game$ball$: 0
}, false, "pong.Game$ball$", {
  Lpong_Game$ball$: 1,
  O: 1
});
$c_Lpong_Game$ball$.prototype.$classData = $d_Lpong_Game$ball$;
var $n_Lpong_Game$ball$ = (void 0);
function $m_Lpong_Game$ball$() {
  if ((!$n_Lpong_Game$ball$)) {
    $n_Lpong_Game$ball$ = new $c_Lpong_Game$ball$().init___()
  };
  return $n_Lpong_Game$ball$
}
/** @constructor */
function $c_Lpong_Model() {
  $c_O.call(this)
}
$c_Lpong_Model.prototype = new $h_O();
$c_Lpong_Model.prototype.constructor = $c_Lpong_Model;
/** @constructor */
function $h_Lpong_Model() {
  /*<skip>*/
}
$h_Lpong_Model.prototype = $c_Lpong_Model.prototype;
$c_Lpong_Model.prototype.init___ = (function() {
  return this
});
$c_Lpong_Model.prototype.changeDirectionY__Z__V = (function(hit) {
  if (hit) {
    $m_Lpong_Game$ball$().directionY$1 = (-1)
  }
});
$c_Lpong_Model.prototype.racketPositionY__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__I = (function(racketHTML, ballHTML) {
  var ballSize = $doubleToInt($uD(ballHTML.offsetHeight));
  return (($doubleToInt($uD(racketHTML.offsetTop)) - ((ballSize / 2) | 0)) | 0)
});
$c_Lpong_Model.prototype.nextPosition__I__I__I__I = (function(currentPosition, speed, direction) {
  return ((currentPosition + $imul(speed, direction)) | 0)
});
$c_Lpong_Model.prototype.moveBallDirectionX__Lorg_scalajs_dom_raw_HTMLDivElement__I = (function(playgroundHTML) {
  var width = $uD(playgroundHTML.offsetWidth);
  var directionX = $m_Lpong_Game$ball$().directionX$1;
  var positionX = this.nextPosition__I__I__I__I($m_Lpong_Game$ball$().x$1, $m_Lpong_Game$ball$().speed$1, $m_Lpong_Game$ball$().directionX$1);
  if ((positionX > width)) {
    directionX = (-1)
  };
  if ((positionX < 0)) {
...
$c_Lpong_Model.prototype.moveBallPosition__I__I = (function(direction) {
  return $imul($m_Lpong_Game$ball$().speed$1, direction)
});
$c_Lpong_Model.prototype.moveBallDirectionY__Lorg_scalajs_dom_raw_HTMLDivElement__I = (function(playgroundHTML) {
  var height = $uD(playgroundHTML.offsetHeight);
  var directionY = $m_Lpong_Game$ball$().directionY$1;
  var positionY = this.nextPosition__I__I__I__I($m_Lpong_Game$ball$().y$1, $m_Lpong_Game$ball$().speed$1, $m_Lpong_Game$ball$().directionY$1);
  if ((positionY > height)) {
    directionY = (-1)
  };
  if ((positionY < 0)) {
...
$c_Lpong_Model.prototype.moveRacket__Lorg_scalajs_dom_raw_HTMLDivElement__I = (function(racketHTML) {
  var left = $doubleToInt($uD(racketHTML.offsetLeft));
  return ($uZ($m_Lpong_Game$().pressedKey$1.apply__O__O($m_Lpong_Game$Key$().Left$2)) ? (((-5) + left) | 0) : ($uZ($m_Lpong_Game$().pressedKey$1.apply__O__O($m_Lpong_Game$Key$().Right$2)) ? ((5 + left) | 0) : left))
});
$c_Lpong_Model.prototype.changeBallPosition__I__I__I__I__V = (function(dirX, posX, dirY, posY) {
  $m_Lpong_Game$ball$().directionX$1 = dirX;
  $m_Lpong_Game$ball$().directionY$1 = dirY;
  $m_Lpong_Game$ball$().x$1 = (($m_Lpong_Game$ball$().x$1 + posX) | 0);
  $m_Lpong_Game$ball$().y$1 = (($m_Lpong_Game$ball$().y$1 + posY) | 0)
});
var $d_Lpong_Model = new $TypeData().initClass({
  Lpong_Model: 0
}, false, "pong.Model", {
  Lpong_Model: 1,
  O: 1
});
$c_Lpong_Model.prototype.$classData = $d_Lpong_Model;
/** @constructor */
function $c_Lpong_State() {
  $c_O.call(this)
}
$c_Lpong_State.prototype = new $h_O();
$c_Lpong_State.prototype.constructor = $c_Lpong_State;
/** @constructor */
function $h_Lpong_State() {
  /*<skip>*/
}
$h_Lpong_State.prototype = $c_Lpong_State.prototype;
$c_Lpong_State.prototype.init___ = (function() {
  return this
});
$c_Lpong_State.prototype.isStoped__Z = (function() {
  var x = $m_Lpong_Game$().status$1;
  var x$2 = $m_Lpong_Game$Status$().Stopped$2;
  return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
});
$c_Lpong_State.prototype.isRacketHit__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Z = (function(racketHTML, ballHTML) {
  var racketBorderLeft = $doubleToInt($uD(racketHTML.offsetLeft));
  var racketBorderRight = ((racketBorderLeft + $doubleToInt($uD(racketHTML.offsetWidth))) | 0);
  var posX = $m_Lpong_Game$().model$1.nextPosition__I__I__I__I($m_Lpong_Game$ball$().x$1, $m_Lpong_Game$ball$().speed$1, $m_Lpong_Game$ball$().directionX$1);
  var posY = $m_Lpong_Game$().model$1.nextPosition__I__I__I__I($m_Lpong_Game$ball$().y$1, $m_Lpong_Game$ball$().speed$1, $m_Lpong_Game$ball$().directionY$1);
  var racketPosY = $m_Lpong_Game$().model$1.racketPositionY__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__I(racketHTML, ballHTML);
  return (((posX >= racketBorderLeft) && (posX <= racketBorderRight)) && (posY >= racketPosY))
});
$c_Lpong_State.prototype.isGameOver__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__Z = (function(racketHTML, ballHTML) {
  var bottomPos = $doubleToInt($uD(racketHTML.offsetHeight));
  var posY = (($m_Lpong_Game$().model$1.nextPosition__I__I__I__I($m_Lpong_Game$ball$().y$1, $m_Lpong_Game$ball$().speed$1, $m_Lpong_Game$ball$().directionY$1) - bottomPos) | 0);
  var racketPosY = $m_Lpong_Game$().model$1.racketPositionY__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLDivElement__I(racketHTML, ballHTML);
  return (posY > racketPosY)
});
$c_Lpong_State.prototype.isRunning__Z = (function() {
  var x = $m_Lpong_Game$().status$1;
  var x$2 = $m_Lpong_Game$Status$().Running$2;
  return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
});
var $d_Lpong_State = new $TypeData().initClass({
  Lpong_State: 0
}, false, "pong.State", {
  Lpong_State: 1,
  O: 1
});
$c_Lpong_State.prototype.$classData = $d_Lpong_State;
/** @constructor */
function $c_Lpong_View() {
  $c_O.call(this)
}
$c_Lpong_View.prototype = new $h_O();
$c_Lpong_View.prototype.constructor = $c_Lpong_View;
/** @constructor */
function $h_Lpong_View() {
  /*<skip>*/
}
$h_Lpong_View.prototype = $c_Lpong_View.prototype;
$c_Lpong_View.prototype.init___ = (function() {
  return this
});
$c_Lpong_View.prototype.drawScore__Lorg_scalajs_dom_raw_HTMLDivElement__V = (function(scoreHTML) {
  var this$1 = $m_Lpong_Game$().score$1;
  scoreHTML.innerHTML = ("" + this$1)
});
$c_Lpong_View.prototype.drawBall__Lorg_scalajs_dom_raw_HTMLDivElement__V = (function(ballHTML) {
  ballHTML.style.left = ($m_Lpong_Game$ball$().x$1 + "px");
  ballHTML.style.top = ($m_Lpong_Game$ball$().y$1 + "px")
});
$c_Lpong_View.prototype.drawEndGame__Lorg_scalajs_dom_raw_HTMLDivElement__Z__V = (function(gameOverHTML, isOver) {
  if (isOver) {
    gameOverHTML.style.display = "block"
  }
});
$c_Lpong_View.prototype.drawRacket__Lorg_scalajs_dom_raw_HTMLDivElement__I__V = (function(racketHTML, pixelPos) {
  racketHTML.style.left = (pixelPos + "px")
});
var $d_Lpong_View = new $TypeData().initClass({
  Lpong_View: 0
}, false, "pong.View", {
  Lpong_View: 1,
  O: 1
});
$c_Lpong_View.prototype.$classData = $d_Lpong_View;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
/** @constructor */
function $c_Lpong_Game$Key$() {
  $c_s_Enumeration.call(this);
  this.Left$2 = 0;
  this.Right$2 = 0
}
$c_Lpong_Game$Key$.prototype = new $h_s_Enumeration();
$c_Lpong_Game$Key$.prototype.constructor = $c_Lpong_Game$Key$;
/** @constructor */
function $h_Lpong_Game$Key$() {
  /*<skip>*/
}
$h_Lpong_Game$Key$.prototype = $c_Lpong_Game$Key$.prototype;
$c_Lpong_Game$Key$.prototype.init___ = (function() {
  $c_s_Enumeration.prototype.init___I.call(this, 0);
  this.Left$2 = 37;
  this.Right$2 = 39;
  return this
});
var $d_Lpong_Game$Key$ = new $TypeData().initClass({
  Lpong_Game$Key$: 0
}, false, "pong.Game$Key$", {
  Lpong_Game$Key$: 1,
  s_Enumeration: 1,
...
$c_Lpong_Game$Key$.prototype.$classData = $d_Lpong_Game$Key$;
var $n_Lpong_Game$Key$ = (void 0);
function $m_Lpong_Game$Key$() {
  if ((!$n_Lpong_Game$Key$)) {
    $n_Lpong_Game$Key$ = new $c_Lpong_Game$Key$().init___()
  };
  return $n_Lpong_Game$Key$
}
/** @constructor */
function $c_Lpong_Game$Status$() {
  $c_s_Enumeration.call(this);
  this.Stopped$2 = null;
  this.Running$2 = null;
  this.GameOver$2 = null
}
$c_Lpong_Game$Status$.prototype = new $h_s_Enumeration();
$c_Lpong_Game$Status$.prototype.constructor = $c_Lpong_Game$Status$;
/** @constructor */
function $h_Lpong_Game$Status$() {
  /*<skip>*/
}
$h_Lpong_Game$Status$.prototype = $c_Lpong_Game$Status$.prototype;
$c_Lpong_Game$Status$.prototype.init___ = (function() {
  $c_s_Enumeration.prototype.init___I.call(this, 0);
  $n_Lpong_Game$Status$ = this;
  var name = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Stopped");
  var i = this.nextId$1;
  this.Stopped$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i, name);
  var name$1 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Running");
  var i$1 = this.nextId$1;
  this.Running$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$1, name$1);
  var name$2 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "GameOver");
  var i$2 = this.nextId$1;
  this.GameOver$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$2, name$2);
  return this
});
var $d_Lpong_Game$Status$ = new $TypeData().initClass({
  Lpong_Game$Status$: 0
}, false, "pong.Game$Status$", {
  Lpong_Game$Status$: 1,
  s_Enumeration: 1,
  O: 1,
  s_Serializable: 1,
...
$c_Lpong_Game$Status$.prototype.$classData = $d_Lpong_Game$Status$;
var $n_Lpong_Game$Status$ = (void 0);
function $m_Lpong_Game$Status$() {
  if ((!$n_Lpong_Game$Status$)) {
    $n_Lpong_Game$Status$ = new $c_Lpong_Game$Status$().init___()
  };
  return $n_Lpong_Game$Status$
}
function $is_T(obj) {
...
$c_s_Enumeration$Val.prototype.toString__T = (function() {
  return ((this.name$2 !== null) ? this.name$2 : (((("<Unknown name for enum field #" + this.i$2) + " of class ") + $objectGetClass(this)) + ">"))
});
...
$e.pong = ($e.pong || {});
$e.pong.Game = $m_Lpong_Game$;
$m_Lpong_Game$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=pong-sam-scalajs2-fastopt.js.map
